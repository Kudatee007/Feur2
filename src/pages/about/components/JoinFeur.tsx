...
const JoinFeur: React.FC = () => {
  return (
    <section className="relative bg-[#3894A3] py-24 px-5 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center text-white">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-20 h-16 rounded-2xl bg-[#2F414F] flex items-center justify-center shadow-lg
            ...
            <img src={joinIcon} alt="" className="w-10 h-10" />
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-8 py-3.5 rounded-full bg-[#2F414F]
            hover:bg-[#1e2e38] active:scale-95
            text-white text-sm font-medium shadow-md
            transition-all duration-300 hover:shadow-lg">
            Download the App
          </button>

          <button className="px-8 py-3.5 rounded-full
            border-2 border-white text-white text-sm font-medium
            hover:bg-white hover:text-[#3894A3] active:scale-95
